...
public class Reporting extends TestListenerAdapter {
	...
	public void onStart(ITestContext testContext) {
		...
		extent.setSystemInfo("user", "Aashutosh");

		htmlReporter.config().setDocumentTitle("JCP Test Project"); // Tile of report
		htmlReporter.config().setReportName("JCP Test Automation Report"); // name of the report
